...
public class Array01 {
	...
	public static void main(String[] args) {
		...
		int s1 = sc.nextInt();
		sum += s1;
		System.out.println("1번 학생의 점수는 " + s1 + "입니다.");
		
		System.out.print("2번 학생 점수 : ");
		int s2 = sc.nextInt();
		sum += s2;
		System.out.println("2번 학생의 점수는 " + s2 + "입니다.");
		
		System.out.print("3번 학생 점수 : ");
		int s3 = sc.nextInt();
		sum += s3;
		System.out.println("3번 학생의 점수는 " + s3 + "입니다.");
		
		System.out.print("4번 학생 점수 : ");
		int s4 = sc.nextInt();
		sum += s4;
		System.out.println("4번 학생의 점수는 " + s4 + "입니다.");
		
		System.out.print("5번 학생 점수 : ");
		int s5 = sc.nextInt();
		sum += s5;
		System.out.println("5번 학생의 점수는 " + s5 + "입니다.");
